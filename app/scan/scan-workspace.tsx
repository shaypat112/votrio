...
type ScanResult = { repoUrl: string; totalFindings: number; findings: Finding[]; profile: RepositoryProfile; intelligence: ScanIntelligence | null; scan?: { score?: number; created_at?: string } | null };
