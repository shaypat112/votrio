...
export const MacbookScroll = ({
  ...
  if (compact) return <CompactMacbook screen={screen} />;
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {screen ? <div className="absolute inset-2 overflow-hidden rounded-lg">{screen}</div> : src ? <Image src={src} alt="Product interface" fill sizes="512px" className="rounded-lg object-cover object-left-top" /> : null}
      </motion.div>
    </div>
  );
};
